...
const iconMap = {
  random: TrademarkCircleFill,
  concentric: ChromeFill,
  circle: BranchesOutline,
  force: AppstoreFill,
  dagre: ApartmentOutline,
  grid: CopyrightCircleFill,
  radial: ShareAltOutline,
};
  ...
  return (
    <div style={{ position: 'absolute', top: 10, left: 10 }}>
      <Select style={{ width: '120px' }} value={value} onChange={onChange}>
        {options.map(item => {
          const { type } = item;
          const iconComponent = iconMap[type] || CustomerServiceFill;
          return (
