...
- Product Capability: Graphin possess heart to make products. After open source, we will continue to improve Graphin in all aspects and plan to add Map Mode, Timebar and other advanced analysis methods.
...
Graphin was born from graph analysis business team. The first version was developed using cytoscape.js. As there are more customized requirements and business needs arise, we decided to switch the engine to G6 and worked closely with the G6's developers to slowly integrate into the entire AntV system. The mindmap belows are the feature completed by Graphin.
